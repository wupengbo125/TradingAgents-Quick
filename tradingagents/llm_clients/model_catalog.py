...
_MINIMAX_MODELS: Dict[str, List[ModelOption]] = {
    "quick": [
        ("MiniMax-M3-highspeed - Faster M3, 204K ctx, ~100 TPS", "MiniMax-M3-highspeed"),
    ...
    "deep": [
        ("MiniMax-M3 - Flagship, SOTA on coding/agent benchmarks, 204K ctx", "MiniMax-M3"),
        ("MiniMax-M3-highspeed - Same quality as M3, ~100 TPS", "MiniMax-M3-highspeed"),
        ("MiniMax-M2.7 - Previous-gen flagship, 204K ctx", "MiniMax-M2.7"),
        ("MiniMax-M2.7-highspeed - Faster M2.7, ~100 TPS", "MiniMax-M2.7-highspeed"),
        ("MiniMax-M2.1 - Base M2, 204K ctx", "MiniMax-M2.1"),
        ("Custom model ID", "custom"),
    ],
}
